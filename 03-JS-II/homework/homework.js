...
function saludo(idioma) {
  ...
  // Tu código:
  return idioma === 'aleman'? 'Guten Tag!': idioma === 'mandarin'?'Ni Hao!':
...
function operadoresLogicos(num1, num2, num3) {
  ...
  return num1 <=-1 || num2 <= -1||num3 <=-1?'Hay negativos':
          num1 ===0 || num2 ===0 || num3 ===0?'Error':
          num1 >num2 && num1>num3 && Math.sign(num1) ===1?'Número 1 es mayor y positivo':
